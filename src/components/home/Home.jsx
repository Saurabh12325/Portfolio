            ...
            <div className="bg-[#1A1A1A]  w-screen h-screen gap-20 flex justify-center items-center relative">
                ...
                <div className='flex flex-col md:hidden justify-center items-center w-full h-full'>
                  <div className="right md:hidden  mb-28 p-3 z-50  "> "
                    <motion.img 
                      whileInView={{ scale: [0, 0.85]}}
                        transition={{ duration: 2, ease: 'easeInOut' }} 
                       
                     img src={ss} className='h-[400px] w-[430px] object-cover rounded-[100%] border-red border-3 shadow-red-500 shadow-xl ' alt="" />
                </div>
                  <div className=" left md:hidden z-[100] p-2 flex flex-col cursor-pointer ">
                    <motion.h1
                        ...
                        className={`text-white text-3xl flex fixed top-[550px] font-bold '}`}>
